...
class OpenAICompatibleProvider(LLMProvider):
    ...
    def __init__(self, api_key: str, model: str, base_url: str | None = None, extra_headers: dict | None = None):
    ...
    def _convert_messages(self, messages: list[Message], system: str | None) -> list[dict]:
        ...
        for msg in messages:
            if msg.role == "tool":
                ...
                result.append({"role": "assistant", "content": msg.content or "", "tool_calls": tc_formatted})
            else:
