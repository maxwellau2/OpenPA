...
\textbf{Tool filtering}: The keywords ``daily'' and ``briefing'' activate the \textit{communication} and \textit{productivity} categories, exposing 30 tools (from a total of 88).
