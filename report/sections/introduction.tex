...
\begin{enumerate}[leftmargin=*]
  \item \textbf{Unified multi-service orchestration}: 87 MCP-compliant tools across 16 services, accessible through natural language with automatic credential management and per-user isolation.
  ...
  \item \textbf{Context-aware tool filtering}: A dynamic tool selection mechanism that reduces the tool set exposed to the LLM from 87 to as few as 8 tools based on task context, enabling effective use of smaller local models.
\end{enumerate}
